<template>
    <header>
        ...
        <nav>
            <ul>
                <router-link to="/InicioCliente" class="link">
                ...
                <router-link to="/reservacion_hora_cliente" class="link"><!--CAMBIAR POR RESERVAR HORA -->
                    <span class="link-icon">
                    <!-- icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" class="size-6">
                    ...
                    <span class="link-title">Reservar</span>
                </router-link>
                <router-link to="/MascotaCliente" class="link">
                    <span class="link-icon">
                        <!-- icon -->
                    ...
                    <span class="link-title">Mascotas</span>
                </router-link>
                <router-link to="/Nosotros" class="link">
                    <span class="link-icon">
                        <!-- icon -->
